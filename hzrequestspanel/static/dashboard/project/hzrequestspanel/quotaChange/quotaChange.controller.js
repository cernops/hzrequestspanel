angular.module('horizon.dashboard.project.hzrequestspanel')
    .controller('DialogControllerQuotaChange', DialogControllerQuotaChange);

DialogControllerQuotaChange.$inject = [
    '$scope',
    '$mdDialog',
    '$mdSidenav',
...
function DialogControllerQuotaChange($scope, $mdDialog, $mdSidenav, novaAPI, keystoneAPI, cinderAPI, settingsAPI, apiService, toastService) {
